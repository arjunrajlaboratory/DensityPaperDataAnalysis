...
for i = 1:numel(contents)
    ...
    for j = 1:numel(objects)
        ...
        [volOrig xtOrig ytOrig ztOrig xbOrig ybOrig zbOrig ctfOrig cbfOrig gpt gpb] = findVol_Expand(obj, color, x, y, z, 1);
        ...
        %We want "real" (original) volume / "fake" volume ratio -> 1 (say to within 10%)
