function [numbersData] = getnumbersandvolume(fillChannel,countChannel,cyclinChannel,intChannel);
...
for i = 1:numel(contents)
    ...
    for j = 1:numel(objects)
        ...
        numbersData(m,:) = [obj.metadata.volumeRealUnits numFillRNA numCountRNA numCyclinRNA numIntRNA];
        m = m+1;
    end
end

dlmwrite('NumbersVolume.txt',numbersData,'\t');