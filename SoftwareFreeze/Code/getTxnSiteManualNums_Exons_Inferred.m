...
for i = 1:numel(contents)
    ...
    for j = 1:numel(objects)
        ...
        goodIdx = obj.metadata.txnSiteIdx_Exons_Inferred;
        ...
        if numel(goodIdx) == 0
            ...
            intV = obj.channels.(countChannel).metadata.gaussFitPostProc.amp(goodIdx);
        ...
        %Normalize to single spot intensity
        intAvg = intAvg/singleSpotIntens;
        intVal = intVal/singleSpotIntens;
...
dlmwrite('TxnSiteIntensityManual_Exons_Inferred.txt',dat,'\t');