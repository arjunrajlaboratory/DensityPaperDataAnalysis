function [numbersData] = getnumbers_novolume_dapi(fillChannel,countChannel,cyclinChannel,intChannel);
...
for i = 1:numel(contents)
    ...
    for j = 1:numel(objects)
        ...
        numbersData(m,:) = [i j numFillRNA numCountRNA numCyclinRNA numIntRNA nucSum nucAvg];
        m = m+1;
    end
end

dlmwrite('Numbers_Dapi.txt',numbersData,'\t');