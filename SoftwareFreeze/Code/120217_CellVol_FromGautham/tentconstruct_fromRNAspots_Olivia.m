function [ cellvolume cellheight celltop cellbottom] = tentconstruct_fromRNAspots_Olivia( dapiMask, objmask , rnacoords , image , interpType)
...
% interpolation.
Ftop=TriScatteredInterp(topdt,toptent(:,3),interpType);
Fbottom=TriScatteredInterp(bottomdt,bottomtent(:,3),interpType);
