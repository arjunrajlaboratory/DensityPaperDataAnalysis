...
fpkmDat <- read.delim('~/Dropbox/densitypaper/densitypaperdataanalysis/SingleCellSeqData/genomicDataFpkm.txt',header=T,stringsAsFactors=F)
...
lowNoise <- read.delim('~/Dropbox/densitypaper/densitypaperdataanalysis/SupplementaryFigures/SingleCellSeq_LowHi_SpecNon/LowNm_HighNm/low_Nm_after_transform.txt',header=F,stringsAsFactors=F)
colnames(lowNoise) <- 'gene'
lowNoiseGenes <- lowNoise$gene

highNoise <- read.delim('~/Dropbox/densitypaper/densitypaperdataanalysis/SupplementaryFigures/SingleCellSeq_LowHi_SpecNon/LowNm_HighNm/high_Nm_after_transform.txt',header=F,stringsAsFactors=F)
...
pdf('~/Dropbox/densitypaper/densitypaperdataanalysis/densityfigures/Figure6/Spec_NonSpec_Genes/Spec_Nonspec_LowNoise_HighNoise.pdf',height=2,width=1.3)
