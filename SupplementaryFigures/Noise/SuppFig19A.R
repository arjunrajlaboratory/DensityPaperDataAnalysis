...
data <- read.delim('~/Dropbox/densitypaper/densitypaperdataanalysis/ExtractedData/A549.txt',header=T,stringsAsFactors=F)
...
highnoise <- subset(outMelt,gene %in% c('ACTA2','ICAM1','EBF1','LUM'))
lownoise <- subset(outMelt,!(gene %in% c('ACTA2','ICAM1','EBF1','LUM')))

pdf('~/Dropbox/densitypaper/densitypaperdataanalysis/SupplementaryFigures/Noise/A549_highnoise.pdf',width=2.5,height=3)
...
pdf('~/Dropbox/densitypaper/densitypaperdataanalysis/SupplementaryFigures/Noise/A549_lownoise.pdf',width=7.5,height=3)
