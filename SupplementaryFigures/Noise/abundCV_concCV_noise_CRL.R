...
pdf('~/Dropbox/densitypaper/SupplementaryFigures/Noise/CRL_highnoise.pdf',width=2.5,height=3)
...
pdf('~/Dropbox/densitypaper/SupplementaryFigures/Noise/CRL_lownoise.pdf',width=7.5,height=3)
