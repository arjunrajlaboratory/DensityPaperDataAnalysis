...
data <- read.delim('~/Dropbox/densitypaper/ExtractedData/A549.txt',header=T,stringsAsFactors=F)
...
pdf('~/Dropbox/densitypaper/SupplementaryFigures/Noise/A549_highnoise.pdf',width=2.5,height=3)
...
pdf('~/Dropbox/densitypaper/SupplementaryFigures/Noise/A549_lownoise.pdf',width=7.5,height=3)
