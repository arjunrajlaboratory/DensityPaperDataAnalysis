...
data <- read.delim('~/Dropbox/densitypaper/ExtractedData/SerumStarved.txt',header=T,stringsAsFactors=F)
...
pdf('~/Dropbox/densitypaper/SupplementaryFigures/Noise/Quies_highnoise.pdf',width=2.5,height=3)
...
pdf('~/Dropbox/densitypaper/SupplementaryFigures/Noise/Quies_lownoise.pdf',width=5,height=3)
