...
highnoise <- subset(outMelt,gene %in% c('ACTA2','ICAM1','FUCA1','LUM','MYC','RND3'))
lownoise <- subset(outMelt,!(gene %in% c('ACTA2','ICAM1','FUCA1','LUM','MYC','RND3')))

pdf('~/Dropbox/densitypaper/densitypaperdataanalysis/SupplementaryFigures/Noise/CRL_highnoise.pdf',width=2.5,height=3)
...
pdf('~/Dropbox/densitypaper/densitypaperdataanalysis/SupplementaryFigures/Noise/CRL_lownoise.pdf',width=7.5,height=3)
