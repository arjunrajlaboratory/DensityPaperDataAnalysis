...
seqData <- read.delim('~/Dropbox/densitypaper/densitypaperdataanalysis/SingleCellSeqData/genomicDataFpkm.txt',header=T,stringsAsFactors=F)
seqData <- subset(seqData,gene_id %in% unique(fishData$gene))
seqData <- subset(seqData,type %in% 'Live')

volData <- read.delim('~/Dropbox/densitypaper/densitypaperdataanalysis/SingleCellSeqData/fpkmRatio.txt',header=T,stringsAsFactors=F)
...
#write.table(seqData,'~/Dropbox/densitypaper/densitypaperdataanalysis/SingleCellSeqData/seqData_volume_and_counts_fishGenes.txt')
...
seqDataTotal <- read.delim('~/Dropbox/densitypaper/densitypaperdataanalysis/SingleCellSeqData/genomicDataFpkm.txt',header=T,stringsAsFactors=F)
...
#write.table(seqDataTotal,'~/Dropbox/densitypaper/densitypaperdataanalysis/SingleCellSeqData/seqData_volume_and_counts_allGenes.txt')
...
pdf(file='~/Dropbox/densitypaper/densitypaperdataanalysis/SupplementaryFigures/SingleCellSeq_CalibrateData/cdfPlot.pdf',height=3,width=3.3)
cdfPlot
dev.off()

pdf(file='~/Dropbox/densitypaper/densitypaperdataanalysis/SupplementaryFigures/SingleCellSeq_CalibrateData/volumeVsRnaPlot.pdf',height=3,width=3.3)
volumeVsRnaPlot
dev.off()

pdf(file='~/Dropbox/densitypaper/densitypaperdataanalysis/SupplementaryFigures/SingleCellSeq_CalibrateData/fishVsFpkmPlot.pdf',height=3,width=3.3)
fishVsFpkm
dev.off()

pdf(file='~/Dropbox/densitypaper/densitypaperdataanalysis/SupplementaryFigures/SingleCellSeq_CalibrateData/fishVsFpkmPlot2.pdf',height=3,width=3.3)
fishVsFpkm2
dev.off()