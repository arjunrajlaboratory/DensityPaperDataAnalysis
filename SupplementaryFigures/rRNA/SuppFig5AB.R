...
data <- read.delim('~/Dropbox/densitypaper/densitypaperdataanalysis/ExtractedData/rRNA.txt',header=T,stringsAsFactors=F)
...
pdf('~/Dropbox/densitypaper/densitypaperdataanalysis/SupplementaryFigures/rRNA/rRNA.pdf',height=3,width=3.3)
...
pdf('~/Dropbox/densitypaper/densitypaperdataanalysis/SupplementaryFigures/rRNA/rRNA_ITS.pdf',height=3,width=3.3)
