...
halflife <- read.delim('~/Dropbox/densitypaper/halflife.txt',header=T,stringsAsFactors=F)
...
pdf('~/Dropbox/densitypaper/SupplementaryFigures/Noise2/halflife_noise.pdf',width=3.3,height=3)
