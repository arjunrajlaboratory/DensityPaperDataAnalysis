...
heights <- read.delim('~/Dropbox/densitypaper/SupplementaryFigures/FixationAndVolume/Heights_All.txt',
...
pdf('~/Dropbox/densitypaper/SupplementaryFigures/FixationAndVolume/Height.pdf',width=7,height=3)
