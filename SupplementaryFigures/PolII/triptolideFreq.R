...
data <- read.delim('~/Dropbox/densitypaper/ExtractedData/triptolide.txt',header=T,stringsAsFactors=F)
...
pdf('~/Dropbox/densitypaper/SupplementaryFigures/PolII/MYCfreq.pdf',width=2,height=4)
...
#tmp$conc <- factor(tmp$conc, levels = c('Ctrl','1nM','10nM','100nM','1uM','10uM'))
...
pdf('~/Dropbox/densitypaper/SupplementaryFigures/PolII/UBCfreq.pdf',width=2,height=4)
