...
pdf('~/Dropbox/densitypaper/SupplementaryFigures/Noise_OldFig4/Figure4/Abund_Conc/abund_hist_TBCB.pdf',width=3.5,height=2)
...
pdf('~/Dropbox/densitypaper/SupplementaryFigures/Noise_OldFig4/Figure4/Abund_Conc/concentration_hist_TBCB.pdf',width=3.5,height=2)
grid.arrange(scatter, hist_right, ncol=2, nrow=1, widths=c(3, 1.5), heights=c(1.7, 3.5))
dev.off()
####