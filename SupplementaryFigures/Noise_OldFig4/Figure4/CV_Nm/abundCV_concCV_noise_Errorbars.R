...
data <- subset(data,gene %in% c('GAPDH','EEF2','MYC','LMNA','TBCB','UBC','RND3'))
...
pdf('~/Dropbox/densitypaper/SupplementaryFigures/Noise_OldFig4/Figure4/CV_Nm/gene_noise_measures_errorbars.pdf',width=2.5,height=2)
...
#write.table(outMelt,'~/Dropbox/densitypaper/densityfigures/Figure4/CV_Nm/CV_Nm_Table.txt',quote=F,sep='\t',row.names=F,col.names=T)
