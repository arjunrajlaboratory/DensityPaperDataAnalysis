...
#sen <- read.delim('~/Dropbox/densitypaper/ExtractedData/Senescent.txt',header=T,stringsAsFactors=F)
...
pdf('~/Dropbox/densitypaper/SupplementaryFigures/VolumeDepIndepTxn/Vol_Indep_Cyc_Qui.pdf',width=3.3,height=3)
...
pdf('~/Dropbox/densitypaper/SupplementaryFigures/VolumeDepIndepTxn/Vol_Dep_Cyc_Qui.pdf',width=3.3,height=3)
