...
pathToData <- '~/Dropbox/densitypaper/densitypaperdataanalysis/WormData/140710_wormdensity_analysis_sizeComp'
...
pathToGraphs <- '~/Dropbox/densitypaper/densitypaperdataanalysis/SupplementaryFigures/WormFig/'
