...
data <- read.delim('~/Dropbox/densitypaper/densitypaperdataanalysis/ExtractedData/CRL.txt',header=T,stringsAsFactors=T)
...
pdf('~/Dropbox/densitypaper/densitypaperdataanalysis/SupplementaryFigures/NuclearSizeVsVolume/NuclearSizeVsVolume_CellCycle.pdf',width=4,height=3)
...
pdf('~/Dropbox/densitypaper/densitypaperdataanalysis/SupplementaryFigures/NuclearSizeVsVolume/NuclearSize_Stage.pdf',width=3.3,height=3)
