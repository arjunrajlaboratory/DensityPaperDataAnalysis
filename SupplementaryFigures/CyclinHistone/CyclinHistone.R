...
data <- read.delim('~/Dropbox/densitypaper/ExtractedData/histonecyclin.txt',
                   header=T,stringsAsFactors=F)

pdf('~/Dropbox/densitypaper/SupplementaryFigures/CyclinHistone/CyclinHistone.pdf',width=5,height=3)
