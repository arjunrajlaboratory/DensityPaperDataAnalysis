...
cycling <- read.delim('~/Dropbox/densitypaper/densitypaperdataanalysis/ExtractedData/CRL.txt',header=T,stringsAsFactors=F)
...
pdf('~/Dropbox/densitypaper/densitypaperdataanalysis/SupplementaryFigures/DensityCyclingQuiescent/Density.pdf',width=3.3,height=3)
