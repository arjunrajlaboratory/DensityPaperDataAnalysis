data <- read.delim('~/Dropbox/densitypaper/densitypaperdataanalysis/ExtractedData/ActD_SerumStarved.txt',header=T,stringsAsFactors=F)
...
pdf('~/Dropbox/densitypaper/densitypaperdataanalysis/SupplementaryFigures/ActD/UBC_decay.pdf',height=3,width=3.2)
