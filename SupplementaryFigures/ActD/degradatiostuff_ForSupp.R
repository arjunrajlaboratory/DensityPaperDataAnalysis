...
pdf(file='~/Dropbox/densitypaper/SupplementaryFigures/ActD/Degradation_IER2.pdf',height=4,width=4.4)
...
pdf(file='~/Dropbox/densitypaper/SupplementaryFigures/ActD/VolumeBeforeAfter.pdf',height=3,width=3.2)
